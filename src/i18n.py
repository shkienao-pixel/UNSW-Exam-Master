...
LANG_MAP: Final[dict[str, dict[str, str]]] = {
    "en": {
        ...
        "content_guard_toggle": "🛡️ Enable Content Guard",
        "content_guard_result": "Cleaned: {before}→{after} chars",
        "rag_nav": "💬 RAG Expert Hub",
        "rag_image_upload": "Upload Question Image",
        "rag_source": "Source",
        "planner_nav": "📅 Study Planner",
        "planner_start": "Study Start Date",
        "planner_exam": "Exam Date",
        "planner_days_left": "{n} days left",
        "planner_no_syllabus": "Generate outline first",
        "deep_link_btn": "🔍 Deep Analysis",
        "changelog_sidebar": "Changelog",
        "mastery_lang_zh": "中文 Only",
        "mastery_lang_bilingual": "中英 Bilingual",
        "mastery_lang_en": "English Only",
        "mastery_hint": "Double-click node to toggle mastery (green border)",
    },
    "zh": {
        "lang_label": "语言",
        "lang_en": "English",
        ...
        "explanation": "解析",
        "content_guard_toggle": "🛡️ 启用内容清洗",
        "content_guard_result": "清洗完成：{before}→{after} 字符",
        "rag_nav": "💬 AI 问答中枢",
        "rag_image_upload": "上传题目图片",
        "rag_source": "来源",
        "planner_nav": "📅 学习计划",
        "planner_start": "复习开始日期",
        "planner_exam": "考试日期",
        "planner_days_left": "剩余 {n} 天",
        "planner_no_syllabus": "请先生成大纲",
        "deep_link_btn": "🔍 详细解析",
        "changelog_sidebar": "更新日志",
        "mastery_lang_zh": "仅中文",
        "mastery_lang_bilingual": "中英对照",
        "mastery_lang_en": "仅英文",
        "mastery_hint": "双击节点切换掌握状态（绿色边框=已掌握）",
    },
}
